      ...
      <div className="ptb-100">
        <div className="container">
          <div className="main-text-content">
            <h4>Our website</h4>
            <p>Our website address is: https://lofi.com/</p>
            ...
            <p>
              This site is provided by <strong>Lofi</strong>.{" "}
              <strong>Lofi</strong> collects information in several ways from
            ...
            <p>
              <strong>Lofi</strong> accepts the following payment methods:
            </p>
            <ul>
              <li>
              ...
              <li>
                <strong>Lofi</strong> features a Fast Checkout option, allowing
            ...
            <p>Last updated: June 19, 2024 at 24:00 pm</p>
          </div>
        </div>
      </div>
